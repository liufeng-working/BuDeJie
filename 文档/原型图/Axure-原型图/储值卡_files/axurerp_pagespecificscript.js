...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('使用储值卡.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('发卡记录.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('消费记录.html');
