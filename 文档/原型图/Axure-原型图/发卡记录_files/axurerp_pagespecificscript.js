...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('搜索_7.html');

}
});
gv_vAlignTable['u5'] = 'center';gv_vAlignTable['u7'] = 'center';gv_vAlignTable['u1'] = 'center';document.getElementById('u2_img').tabIndex = 0;
