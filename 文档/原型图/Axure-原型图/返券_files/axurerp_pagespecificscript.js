...
gv_vAlignTable['u3'] = 'center';document.getElementById('u12_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('回收记录.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('优惠验证_1.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('发放记录.html');
