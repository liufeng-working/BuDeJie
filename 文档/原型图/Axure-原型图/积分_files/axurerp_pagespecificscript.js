...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('回收.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('发放记录_1.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('积分验证.html');
